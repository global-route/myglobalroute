...
(function (global) {
  ...
  function recommend(profile, countries, pathways, limit = 5) {
    ...
    return pathways
      .map(pathway => ({ pathway, country: countryMap.get(pathway.countryId) }))
  ...
  global.GlobalRoute = global.GlobalRoute || {};
  global.GlobalRoute.RouteEngine = { recommend, scorePathway };
})(window);
